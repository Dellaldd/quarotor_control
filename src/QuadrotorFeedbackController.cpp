...
void QuadrotorFeedbackController::positionPlanningFeedback(geometry_msgs::PoseStamped position_setpoint_cmd)
{
  Eigen::Vector3d position_cmd_(position_setpoint_cmd.pose.position.x, position_setpoint_cmd.pose.position.y, position_setpoint_cmd.pose.position.z);
  Eigen::Vector3d position_error_ = position_cmd_ - current_position_;

  printf("x = %0.2f, y = %0.2f, z = %0.2f \n", position_setpoint_cmd.pose.position.x, position_setpoint_cmd.pose.position.y, position_setpoint_cmd.pose.position.z);
